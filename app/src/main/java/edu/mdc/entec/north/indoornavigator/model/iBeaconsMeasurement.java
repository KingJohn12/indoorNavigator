...
public class iBeaconsMeasurement {
    //private int X;
    //private int Y;
    ...
    public iBeaconsMeasurement() {
    }

    public iBeaconsMeasurement(/*int x, int y,*/ int beacon11RSSI, int beacon12RSSI, int beacon21RSSI, int beacon22RSSI, int beacon31RSSI, int beacon32RSSI) {
        //X = x;
        //Y = y;
