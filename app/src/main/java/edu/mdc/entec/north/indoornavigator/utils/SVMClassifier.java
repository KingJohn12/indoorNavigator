package edu.mdc.entec.north.indoornavigator.utils;
...
public class SVMClassifier {
    ...
    private static final String DIR = "/data/data/edu.mdc.entec.north.indoornavigator/files/";
    //TODO mContext.getFilesDir()
    ...
    public CellCoordinates predict(iBeaconsMeasurement measurement) {
        Log.i(TAG, "******MEASURED: ");
        ...
        CellCoordinates cell = new CellCoordinates((int) predicted / 30, (int) predicted % 30);
        return cell;
